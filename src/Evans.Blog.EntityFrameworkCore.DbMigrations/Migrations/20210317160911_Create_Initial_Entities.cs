    ...
    public partial class Create_Initial_Entities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, comment: "The Primary key"),
                    ...
                    CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: false, comment: "The creation time"),
                    CreatorId = table.Column<Guid>(type: "char(36)", nullable: true, comment: "The id of creator"),
                    LastModificationTime = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "The last modification time"),
                    LastModifierId = table.Column<Guid>(type: "char(36)", nullable: true, comment: "The id of last modifier"),
                    IsDeleted = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false, comment: "The flag of deletion：0 not deleted，1 deleted"),
                    DeleterId = table.Column<Guid>(type: "char(36)", nullable: true, comment: "The id of deleter"),
                    DeletionTime = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "The deletion time")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_es_category", x => x.Id);
                },
                comment: "The category of blog.");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_es_friend_link", x => x.Id);
                },
                comment: "The friend link of blog.");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryId = table.Column<Guid>(type: "char(36)", nullable: false, comment: "The category id of blog"),
                    ExtraProperties = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "varchar(40) CHARACTER SET utf8mb4", maxLength: 40, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_es_post", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, comment: "The Primary key"),
                    PostId = table.Column<Guid>(type: "char(36)", nullable: false, comment: "the post id of blog"),
                    TagId = table.Column<Guid>(type: "char(36)", nullable: false, comment: "the tag id of blog"),
                    CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: false, comment: "The creation time"),
                    CreatorId = table.Column<Guid>(type: "char(36)", nullable: true, comment: "The id of creator"),
                    LastModificationTime = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "The last modification time"),
                    LastModifierId = table.Column<Guid>(type: "char(36)", nullable: true, comment: "The id of last modifier"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_es_post_tag", x => x.Id);
                },
                comment: "The post tab of blog.");
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, comment: "The Primary key"),
                    TagType = table.Column<int>(type: "int", maxLength: 50, nullable: false, comment: "the tag name"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_es_tag", x => x.Id);
                },
                comment: "The tag of blog.");
