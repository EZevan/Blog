...
namespace Evans.Blog.Migrations
{
    ...
    [Migration("20210326162801_Add_Avatar")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Evans.Blog.Services.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<Guid?>("CreatorId")
                        ...
                        .HasComment("The id of creator");

                    b.Property<Guid?>("DeleterId")
                        .HasColumnType("char(36)")
                        .HasColumnName("DeleterId")
                        .HasComment("The id of deleter");

                    b.Property<DateTime?>("DeletionTime")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("DeletionTime")
                        .HasComment("The deletion time");
                    ...
                    b.Property<bool>("IsDeleted")
                        ...
                        .HasComment("The flag of deletion：0 not deleted，1 deleted");

                    b.Property<DateTime?>("LastModificationTime")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("LastModificationTime")
                        .HasComment("The last modification time");

                    b.Property<Guid?>("LastModifierId")
                        .HasColumnType("char(36)")
                        .HasColumnName("LastModifierId")
                        .HasComment("The id of last modifier");

                    b.HasKey("Id");

                    b.ToTable("es_category");

                    b
                        .HasComment("The category of blog.");
                });

            modelBuilder.Entity("Evans.Blog.Services.FriendLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
                    ...
                    b.ToTable("es_friend_link");

                    b
                        .HasComment("The friend link of blog.");
                });

            modelBuilder.Entity("Evans.Blog.Services.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
            ...
            modelBuilder.Entity("Evans.Blog.Services.PostTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
                    ...
                    b.ToTable("es_post_tag");

                    b
                        .HasComment("The post tab of blog.");
                });

            modelBuilder.Entity("Evans.Blog.Services.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
